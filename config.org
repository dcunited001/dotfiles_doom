...
**** TODO [#B] bufler/tab-bar-mode display disappears (caused by save-desktop/autoloads)

**** TODO map =C-c o t= or something for tab-line-mode
+ remap vterm hotkeys
