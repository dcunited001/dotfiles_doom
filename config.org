...
You'll need [[http://ngspice.sourceforge.net/ngspice-tutorial.html][ngspice]] and some components.
...
#+BEGIN_EXAMPLE spice :tangle no :comments none :results drawer :var file="img/spice/spice-example"
